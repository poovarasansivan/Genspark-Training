...
namespace MigratedApi.Interfaces
{
    public interface IOrderService
    {
        ...
        Task<List<OrderResponseDto>> CreateOrderAsync(OrderRequestDto orderDto);
        ...
        Task<IEnumerable<OrdersResponseDto>> GetPaginatedOrdersAsync(OrdersPaginationDto paginationDto);
    }
}